...
import { IDataOptions, IDataSet, PivotViewModule, FieldListService, GroupingBarService } from '@syncfusion/ej2-angular-pivotview';
...
export class AppComponent {
  ...
  ngOnInit(): void {
    ...
    this.dataSourceSettings = {
       ...
       values: [{ name: 'Quantity', type:'Avg' }, { name: 'UnitPrice'}],
        rows: [{ name: 'ShipCountry' }, { name: 'ShipCity',showNoDataItems: true }],
        valueAxis: 'column'
